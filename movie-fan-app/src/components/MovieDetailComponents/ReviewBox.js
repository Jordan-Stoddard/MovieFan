...
export default function ReviewBox({review, index}) {
  return (
    <div className="review-box-container">
      ...
      <a target="_blank" rel="noreferrer noopener" href={review.url}  className="review-box-link">See full review <i className="fas fa-external-link-alt"></i></a>
      </div>
    </div>
  )
}
